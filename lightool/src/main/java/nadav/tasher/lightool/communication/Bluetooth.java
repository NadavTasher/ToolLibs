...
public class Bluetooth {
    static class BluetoothSession extends AsyncTask<Tunnel<SessionStatus>, Tunnel<SessionStatus>, SessionStatus> {
        private Context context;
        private String address, data;
        private OnFinish onFinish;

        public BluetoothSession(Context context, String address, String data, OnFinish onFinish) {
            ...
            if (manager != null) {
                ...
                if (blueAdapter.isEnabled()) {
                    ...
                    try {
                        ...
                        try {
                            socket.connect();
                            while (!socket.isConnected())currentStatus.setStatus(SessionStatus.IN_PROGRESS);
                            sendStatus(currentStatus,tunnels);
